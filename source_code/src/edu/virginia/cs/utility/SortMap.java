...
public class SortMap {
     ...
     * descending order
     * @return list of sorted Map.Entry
     */
    public static <K, V> List<Map.Entry<K, V>> sortMapGetList(Map<K, V> unsortMap, final boolean order) {
    ...
    public static <K, V> Map<K, V> sortMapByValue(Map<K, V> unsortMap, final boolean order) {
        ...
        for (Map.Entry<K, V> entry : sortMapGetList(unsortMap, order)) {
